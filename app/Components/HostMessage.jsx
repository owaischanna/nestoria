...
// ====================================================================
// --- Utility Components (Moved/Kept for Context) ---
// ====================================================================

// 1. ConversationItem: Represents a single conversation in the left sidebar
...
// 2. ChatMessage: Represents a single message in the thread
    ...
    return (
        <>
            ...
            <div className={`flex w-full mb-4 ${alignment}`}>
                {/* Guest/Support Avatar (Left side) */}
                {!isHost && (
...
// 3. ConversationThread: The right panel showing the active chat
const ConversationThread = ({ activeContact }) => {
    ...
    const hostAvatar = "/path/to/margaret-johnson-avatar.jpg"; // Placeholder
    const contactAvatar = "/path/to/anna-chen-avatar.jpg"; // Placeholder
...
// ====================================================================
// --- Main Messages Page Component (Layout Wrapper) ---
// ====================================================================
export default function HostMessagesPage() {
    ...
    // The active contact for the right-hand thread
    const activeContact = { name: "Margaret Johnson", role: "Host" }; // Based on the example screenshot
