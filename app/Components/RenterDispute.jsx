...
const DisputeSuccessPage = ({ disputeData, onBackToDisputes }) => {
    return (
        <div className="max-w-4xl mx-auto">
            ...
            {/* Success Message */}
            <div className="bg-orange-50 border border-orange-200 rounded-xl p-6 sm:p-8 mb-8">
                <div className="flex items-center mb-4">
                    <CheckCircle className="w-8 h-8 text-orange-600 mr-3" />
                    <h2 className="text-xl font-bold text-orange-800">Dispute Successfully Filed!</h2>
                </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex items-center p-3 border border-gray-200 rounded-lg">
                                <File className="w-5 h-5 text-orange-500 mr-3" />
                                <div className="flex-1">
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        ...
                        <div className="mt-6 pt-4 border-t border-gray-200">
                            <div className="flex justify-between items-center">
                                ...
                                <span className="text-2xl font-bold text-orange-600">€650.00</span>
                            </div>
                        </div>
                    </div>
    ...
    return (
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6 mb-4 transition-all duration-200 hover:shadow-md">
            ...
            <div className="flex flex-wrap gap-2 sm:gap-3">
                ...
                {isFiledAgainst ? (
                    <>
                        <button className="flex-1 sm:flex-none py-2 px-4 border border-orange-600 text-sm font-medium rounded-lg text-orange-600 bg-white hover:bg-orange-50 transition duration-150">
                            Accept
                        </button>
                    ...
                    {bookings.map((booking) => (
                        <button
                            ...
                            className={`w-full p-4 text-left hover:bg-gray-50 transition duration-150 border-b border-gray-100 last:border-b-0 ${
                                selectedBooking?.id === booking.id ? 'bg-orange-50 border-orange-200' : ''
                            }`}
                        >
            ...
            {step === 1 && (
                <div className="space-y-8">
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        ...
                        <div className="space-y-3">
                            {damageCategories.map((category) => (
                                <label 
                                    key={category.value}
                                    className="flex items-start p-4 border border-gray-200 rounded-lg hover:border-orange-500 transition duration-150 cursor-pointer"
                                >
                                    <input
                                        type="radio"
                                        name="category"
                    ...
                    <button
                        ...
                        className="w-full sm:w-auto bg-orange-600 text-white py-3 px-6 rounded-lg font-medium hover:bg-orange-700 transition duration-150 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                ...
                <div className="space-y-8">
                    ...
                    {formData.booking && (
                        <div className="bg-orange-50 border border-orange-200 rounded-xl p-6">
                            <h3 className="text-lg font-semibold text-orange-800 mb-3">Selected Booking</h3>
                            <div className="flex justify-between items-start">
                                <div>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        ...
                        <div className="mb-6">
                            ...
                            <textarea
                                rows={4}
                                className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-orange-500 focus:border-orange-500 transition duration-150"
                        ...
                        <div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                ...
                                                <input
                                                    type="number"
                                                    className="w-full border border-gray-300 rounded-lg pl-8 pr-3 py-2 text-sm focus:ring-orange-500 focus:border-orange-500"
                                                    placeholder="180.00"
                                                    value={item.cost}
                            ...
                            <button
                                ...
                                className="flex items-center text-orange-600 hover:text-orange-700 font-medium transition duration-150"
                            >
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                        ...
                        <button
                            onClick={onSubmit}
                            className="flex-1 bg-orange-600 text-white py-3 px-6 rounded-lg font-medium hover:bg-orange-700 transition duration-150"
                        >
                            Submit Dispute
                        </button>
                    </div>
...
const GuestDispute = () => {
    ...
    const stats = [
        ...
        { icon: CheckCircle, title: "Resolved Disputes", count: "7", subtitle: "Successfully Closed", color: "text-orange-600", bgColor: "bg-orange-100" },
                    ...
                    <div className="max-w-7xl mx-auto w-full">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center mb-6">
                            <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                                ...
                                <div className="relative flex-1 sm:w-64">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-orange-500 focus:border-orange-500 transition duration-150 text-sm"
                                        value={searchQuery}
                            ...
                            <button
                                ...
                                className="flex items-center py-2 px-4 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition duration-150 text-sm font-medium w-full sm:w-auto justify-center"
                            >
                        ...
                        {filteredDisputes.length === 0 && (
                            <div className="text-center py-12">
                                ...
                                <button
                                    onClick={() => setShowFileDispute(true)}
                                    className="inline-flex items-center py-2 px-4 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition duration-150 text-sm font-medium"
                                >
                                    <Plus className="w-4 h-4 mr-2" />
